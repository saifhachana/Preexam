 ...
 */
final class Version20210418185744 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fournisseur (id INT AUTO_INCREMENT NOT NULL, code_four VARCHAR(10) NOT NULL, des_four VARCHAR(255) DEFAULT NULL, adr_four VARCHAR(100) NOT NULL, contact VARCHAR(100) DEFAULT NULL, contact_four VARCHAR(100) NOT NULL, tel_four VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE jouet (id INT AUTO_INCREMENT NOT NULL, code_four_jouet_id INT NOT NULL, code_jouet VARCHAR(10) NOT NULL, des_jouet VARCHAR(255) NOT NULL, qte_stock_jouet VARCHAR(255) NOT NULL, pu_jouet VARCHAR(50) NOT NULL, INDEX IDX_6B3DFFD85D20E737 (code_four_jouet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
